...
describe Mina::Client do
  let(:indexer_endpoint) { 'http://mina-indexer' }
  let(:indexer_name)     { 'mina' }
  ...
  describe '#status' do
    ...
    it 'returns current status' do
      expect(result).to be_a Mina::Status
      expect(result.app_name).to eq 'mina-indexer'
  ...
  describe '#current_block' do
    ...
    it 'returns current block' do
      expect(result).to be_a Mina::Block
  ...
  describe '#block' do
    it 'returns block by hash' do
      expect(client.block('hash')).to be_a Mina::BlockDetails
    end

    it 'returns block by height' do
      expect(client.block('height')).to be_a Mina::BlockDetails
    end
  end
  ...
  describe '#blocks' do
    ...
    it 'returns most recent blocks' do
      ...
      expect(result.first).to be_a Mina::Block
    end
  end
  ...
  describe '#block_stats' do
    ...
    it 'returns blocks stats for a period' do
      expect(result).to be_a Array
      expect(result.first).to be_a Mina::BlockStat
    end
  end
  ...
  describe '#block_times' do
    ...
    it 'returns block times' do
      expect(result).to be_a Mina::BlockTime
    end
  end
  ...
  describe '#validators' do
    ...
    it 'returns validators' do
      expect(result).to be_a Array
      expect(result.first).to be_a Mina::Validator
    end
  end
  ...
  describe '#validator' do
    ...
    it 'returns validator details' do
      expect(result).to be_a Mina::ValidatorDetails
    end
  end
  ...
  describe '#account' do
    ...
    it 'returns account details' do
      expect(result).to be_a Mina::Account
    end
  end
  ...
  describe '#transactions' do
    ...
    it 'returns transactions' do
      ...
      expect(result.first).to be_a Mina::Transaction
    end
  end
