...
describe Oasis::Client do
  ...
  before do
    ...
    stub_endpoint('/validator/oasis1qp22l6gy0u2cp6krh4ruuezf09f20t0qkupkhq2g', { sequences_limit: 50 }, 'validator')
    stub_endpoint('/validators', { height: 406392 }, 'validators_for_height')
    stub_endpoint('/validators_summary', { period: '48 hours', interval: 'hour', address: 'oasis1qp22l6gy0u2cp6krh4ruuezf09f20t0qkupkhq2g' }, 'validators_summary')
  ...
  describe '#validators_summary' do
    let(:result) { client.validators_summary('hour', '48 hours', 'oasis1qp22l6gy0u2cp6krh4ruuezf09f20t0qkupkhq2g') }
    let(:stat)   { result.first }
  ...
  describe '#validator_events' do
    let(:validator_events) { client.validator_events('oasis1qp22l6gy0u2cp6krh4ruuezf09f20t0qkupkhq2g', 50) }
