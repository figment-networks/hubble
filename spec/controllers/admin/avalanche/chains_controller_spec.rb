...
RSpec.describe Admin::Avalanche::ChainsController do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      let(:params) { attributes_for(:avalanche_chain, slug: 'avalancheslug2') }

      it 'saves the new chain' do
        expect do
          post :create, params: { avalanche_chain: params }
    ...
    context 'with invalid params' do
      let(:params) { attributes_for(:avalanche_chain, slug: chain.slug) }
  ...
  describe 'PUT #update' do
    context 'with no errors' do
      ...
      before { put :update, params: { id: chain.slug, avalanche_chain: new_params } }
    ...
    context 'with errors' do
      ...
      before { put :update, params: { id: chain.slug, avalanche_chain: wrong_new_params } }
