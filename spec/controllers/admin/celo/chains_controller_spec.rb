...
RSpec.describe Admin::Celo::ChainsController do
  ...
  describe 'GET #show', :vcr do
    ...
    # TODO: uncomment when we get access to an indexer
    xit "doesn't show error" do
  ...
  describe 'POST #create' do
    context 'with valid params' do
      let(:params) { attributes_for(:celo_chain, slug: 'celoslug2') }

      it 'saves the new chain' do
        expect do
          post :create, params: { celo_chain: params }
    ...
    context 'with invalid params' do
      let(:params) { attributes_for(:celo_chain, slug: chain.slug) }
  ...
  describe 'PUT #update' do
    context 'with no errors' do
      ...
      before { put :update, params: { id: chain.slug, celo_chain: new_params } }
    ...
    context 'with errors' do
      ...
      before { put :update, params: { id: chain.slug, celo_chain: wrong_new_params } }
