class Coda::TransactionsController < Coda::BaseController
  ...
  def index
    ...
    if request.xhr?
      render partial: 'coda/transactions/index/table', locals: { transactions: @transactions }
      return
    end
  ...
  def init_search_form
    @search_form = Coda::TransactionSearch.new(search_params.to_hash)
