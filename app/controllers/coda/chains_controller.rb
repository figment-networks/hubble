class Coda::ChainsController < Coda::BaseController
  def show
  ...
  def search
    ...
    redirect_to coda_chain_path(@chain)
  end
  ...
  def block_stats
    ...
    Coda::BlockStatsDecorator.new(@chain, stats)
  end

  def transactions_stats
    stats = client.transactions_stats(interval: 'd', period: 30)
    Coda::TransactionsStatsDecorator.new(@chain, stats)
  end
end
